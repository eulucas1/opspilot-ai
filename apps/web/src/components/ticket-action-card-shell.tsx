...
export function TicketActionCardShell({
  ...
  return (
    <section className="flex h-full flex-col rounded-[1.35rem] border border-ink/10 bg-white/92 p-5 shadow-[0_8px_24px_rgba(13,38,59,0.06)] backdrop-blur">
      <header>
      ...
      <div className="mt-4 grow">{body}</div>
